...
const course_texture royal_raceway_textures[] = {
    ...
    { gTexture645134, 0x052C, 0x0800, 0x0 }, // 0x05000800
    { gTextureWoodDoor1, 0x0903, 0x1000, 0x0 }, // 0x05001000
    { gTexture64BB60, 0x0169, 0x0800, 0x0 }, // 0x05002000
    { gTextureGrass3, 0x0372, 0x0800, 0x0 }, // 0x05002800
    { gTexture64F9E8, 0x020B, 0x1000, 0x0 }, // 0x05003000
    { gTextureFlagRed, 0x019E, 0x0800, 0x0 }, // 0x05004000
    { gTextureCrownJewelBlue, 0x0301, 0x0800, 0x0 }, // 0x05004800
    { gTextureCrown, 0x0106, 0x0800, 0x0 }, // 0x05005000
    { gTextureCrownJewelPink, 0x0313, 0x0800, 0x0 }, // 0x05005800
    { gTextureSignKoopaAir0, 0x0360, 0x1000, 0x0 }, // 0x05006000
    { gTextureSignKoopaAir1, 0x0304, 0x1000, 0x0 }, // 0x05007000
    { gTexture6684F8, 0x010D, 0x0800, 0x0 }, // 0x05008000
    { gTextureSignLuigis0, 0x0287, 0x1000, 0x0 }, // 0x05008800
    { gTextureSignLuigis1, 0x02AF, 0x1000, 0x0 }, // 0x05009800
    { gTextureSignMarioStar0, 0x02D2, 0x1000, 0x0 }, // 0x0500A800
    { gTextureSignMarioStar1, 0x02B1, 0x1000, 0x0 }, // 0x0500B800
    { gTexture66CA98, 0x02C9, 0x0800, 0x0 }, // 0x0500C800
    { gTextureCheckerboardPink, 0x0157, 0x0800, 0x0 }, // 0x0500D000
    { gTexture670AC8, 0x0FBF, 0x1000, 0x0 }, // 0x0500D800
    { gTextureRoad0, 0x0300, 0x1000, 0x0 }, // 0x0500E800
    { gTextureRoadFinish0, 0x0338, 0x1000, 0x0 }, // 0x0500F800
    { gTextureSignYoshi, 0x04DF, 0x1000, 0x0 }, // 0x05010800
    { gTextureCheckerboardBlueGray, 0x04A1, 0x1000, 0x0 }, // 0x05011800
    { gTextureCastleBricks, 0x0B33, 0x1000, 0x0 }, // 0x05012800
    { gTextureCastleBridge, 0x0428, 0x0800, 0x0 }, // 0x05013800
    { gTextureGrass8, 0x02CB, 0x0800, 0x0 }, // 0x05014000
    { gTextureGrass9, 0x0421, 0x0800, 0x0 }, // 0x05014800
    { gTexture6646B8, 0x0298, 0x1000, 0x0 }, // 0x05015000
    { gTexture664408, 0x02AE, 0x1000, 0x0 }, // 0x05016000
    { gTextureBricksRed, 0x0C55, 0x1000, 0x0 }, // 0x05017000
    { gTexture665C0C, 0x059D, 0x0800, 0x0 }, // 0x05018000
    { gTexture6661AC, 0x01F7, 0x0800, 0x0 }, // 0x05018800
    { gTexture6663A4, 0x05F6, 0x0800, 0x0 }, // 0x05019000
    { gTexture667BAC, 0x067A, 0x0800, 0x0 }, // 0x05019800
    { gTextureFlagRed2, 0x0186, 0x0800, 0x0 }, // 0x0501A000
    { gTexture66DB60, 0x01D6, 0x0800, 0x0 }, // 0x0501A800
    { gTextureStainglassPeach0, 0x0ED1, 0x1000, 0x0 }, // 0x0501B000
    { gTextureStainglassPeach1, 0x0DA9, 0x1000, 0x0 }, // 0x0501C000
    { gTextureFencePostWooden, 0x083D, 0x1000, 0x0 }, // 0x0501D000
    { gTexture648508, 0x01FE, 0x1000, 0x0 }, // 0x0501E000
    { gTexture6449D4, 0x075D, 0x0800, 0x0 }, // 0x0501F000
    { gTexture67FE0C, 0x02DE, 0x0800, 0x0 }, // 0x0501F800
