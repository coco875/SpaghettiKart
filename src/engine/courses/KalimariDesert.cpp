...
const course_texture kalimari_desert_textures[] = {
    ...
    { gTextureSignLuigis0, 0x0287, 0x1000, 0x0 },           // 0x05000800
    { gTextureSignLuigis1, 0x02AF, 0x1000, 0x0 },           // 0x05001800
    { gTextureSignMarioStar0, 0x02D2, 0x1000, 0x0 },        // 0x05002800
    { gTextureSignMarioStar1, 0x02B1, 0x1000, 0x0 },        // 0x05003800
    { gTextureSignNintendoRed0, 0x02A6, 0x1000, 0x0 },      // 0x05004800
    { gTextureSignNintendoRed1, 0x02F7, 0x1000, 0x0 },      // 0x05005800
    { gTexture67490C, 0x021C, 0x0800, 0x0 },                // 0x05006800
    { gTextureSignYoshi, 0x04DF, 0x1000, 0x0 },             // 0x05007000
    { gTextureCheckerboardBlueGray, 0x04A1, 0x1000, 0x0 },  // 0x05008000
    { gTexture646CA8, 0x073A, 0x1000, 0x0 },                // 0x05009000
    { gTexture6473E4, 0x05AD, 0x1000, 0x0 },                // 0x0500A000
    { gTexture647994, 0x05B5, 0x1000, 0x0 },                // 0x0500B000
    { gTexture668920, 0x03D9, 0x0800, 0x0 },                // 0x0500C000
    { gTextureRailroadTrack, 0x0B5B, 0x1000, 0x0 },         // 0x0500C800
    { gTextureRailroadCrossingTrack, 0x0208, 0x1000, 0x0 }, // 0x0500D800
    { gTexture67291C, 0x059C, 0x0800, 0x0 },                // 0x0500E800
    { gTextureFenceBarbedWire, 0x021E, 0x1000, 0x0 },       // 0x0500F000
    { gTexture67D304, 0x091C, 0x1000, 0x0 },                // 0x05010000
    { gTexture67E010, 0x0415, 0x0800, 0x0 },                // 0x05011000
    { gTexture67EEAC, 0x0140, 0x0800, 0x0 },                // 0x05011800
    { gTextureSignShellShot0, 0x038C, 0x1000, 0x0 },        // 0x05012000
    { gTextureSignShellShot1, 0x0247, 0x1000, 0x0 },        // 0x05013000
    { gTextureSignKoopaAir0, 0x0360, 0x1000, 0x0 },         // 0x05014000
    { gTextureSignKoopaAir1, 0x0304, 0x1000, 0x0 },         // 0x05015000
